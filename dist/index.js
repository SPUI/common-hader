...
var _Drawer = _interopDefault(require('antd/es/drawer'));
require('antd/es/icon/style');
var _Icon = _interopDefault(require('antd/es/icon'));
var i18next = _interopDefault(require('i18next'));
var Backend = _interopDefault(require('i18next-xhr-backend'));
var LngDetector = _interopDefault(require('i18next-browser-languagedetector'));
...
var WebHeader = function WebHeader(_ref) {
  ...
  function renderLogoNav() {
    ...
    var menu = React__default.createElement("div", {
      ...
      return React__default.createElement("li", {
        ...
        alt: ""
      })), React__default.createElement("strong", null, item.currency, " ", t('header:pool'))));
    }), React__default.createElement(_Divider, null), React__default.createElement("li", null, React__default.createElement("a", {
      ...
      alt: ""
    })), React__default.createElement("strong", null, "Staking"))), React__default.createElement("li", null, React__default.createElement("a", {
      ...
      alt: ""
    })), React__default.createElement("strong", null, "SparkOS"))), React__default.createElement("li", {
      ...
      alt: ""
    })), React__default.createElement("strong", null, t('header:download'))))));
  ...
  function renderNavMenu() {
    return React__default.createElement(_Menu, {
      mode: "horizontal",
      ...
      href: MULTICHAIN
    }, t('header:pool'))), React__default.createElement(_Menu.Item, {
      key: "miner"
    }, userInfo.id ? React__default.createElement("a", {
      href: "".concat(MULTICHAIN, "/action/mywallet")
    }, t('header:user.myWorkers')) : React__default.createElement("a", {
      href: "".concat(ACCOUNTSYSTEM, "/login?redirect_uri=").concat(MULTICHAIN, "/action/mywallet")
    }, t('header:user.myWorkers'))), React__default.createElement(_Menu.Item, {
      key: "wallet"
    }, userInfo.id ? React__default.createElement("a", {
      href: WALLETSYSTEM
    }, t('header:wallet')) : React__default.createElement("a", {
      href: "".concat(ACCOUNTSYSTEM, "/login?redirect_uri=").concat(WALLETSYSTEM)
    }, t('header:wallet'))), React__default.createElement(SubMenu, {
      key: "help",
      className: styles.subMenu,
      title: React__default.createElement("span", {
        className: styles.navMenu__subMenu__title
      }, t('header:help.title'), React__default.createElement("img", {
        src: require('../assets/svg/icon-download-black.svg'),
        alt: ""
      }))
    }, React__default.createElement(_Menu.Item, null, React__default.createElement("a", {
      href: "https://sparkpool.zendesk.com/hc/".concat(isCN() ? 'zh-cn' : 'en-us', "/requests/new"),
      target: "_blank",
      rel: "noopener noreferrer"
    }, t('header:help.order'))), React__default.createElement(_Menu.Item, null, React__default.createElement("a", {
      href: "https://support.sparkpool.com/hc/".concat(isCN() ? 'zh-cn' : 'en-us', "/categories/360000149093"),
      target: "_blank",
      rel: "noopener noreferrer"
    }, t('header:help.question'))), React__default.createElement(_Menu.Item, null, React__default.createElement("a", {
      href: "https://mp.weixin.qq.com/mp/homepage?__biz=MzU3MDY4Mjg5Mg==&hid=1&sn=bf68889a560a893a4936fb018b560966",
      target: "_blank",
      rel: "noopener noreferrer"
    }, t('header:help.classroom'))), React__default.createElement(_Menu.Item, null, React__default.createElement("a", {
  ...
  function renderUserInfo() {
    ...
    var menu = React__default.createElement("div", {
      ...
      to: "/setting/mining"
    }, t('header:accountmining'))), React__default.createElement(_Menu.Item, {
      key: "follow"
    }, React__default.createElement(Link, {
      to: "/setting/follow"
    }, t('header:user.follow'))), React__default.createElement(_Menu.Item, {
      key: "account"
    }, React__default.createElement(Link, {
      to: "/setting/account"
    }, t('header:user.default'))), React__default.createElement(_Menu.Item, {
      key: "notice"
    }, React__default.createElement(Link, {
      to: "/setting/notice"
    }, t('header:user.notice'))), React__default.createElement(_Menu.Item, {
      key: "userInfo"
    }, React__default.createElement("a", {
      href: ACCOUNTSYSTEM
    }, t('header:user.setting'))), React__default.createElement(_Menu.Item, {
      key: "logout"
    }, t('header:logout'))));
    ...
    if (!id) {
      ...
      }, t('header:login')), " / ", React__default.createElement("a", {
  ...
  }, renderLogoNav()), React__default.createElement("div", {
    className: styles.WebHeader__nav
  }, renderNavMenu()), React__default.createElement("div", {
...
function (_Component) {
  ...
  function WapHeader() {
    ...
    _this.renderNavDrawer = function () {
      ...
      return React__default.createElement(_Drawer, {
        ...
        type: "wallet"
      }), t('header:wallet'))), React__default.createElement(_Menu.Item, {
        key: "download"
      }, React__default.createElement("a", {
        href: "".concat(MULTICHAIN, "/download")
      }, React__default.createElement(_Icon, {
        type: "cloud-download"
      }), t('header:download'))), React__default.createElement(_Menu.Item, {
        key: "staking"
      }, React__default.createElement("a", {
        href: "https://staking.sparkpool.com"
      }, React__default.createElement("img", {
      ...
      }), "Staking")), React__default.createElement(SubMenu$1, {
        title: React__default.createElement("span", null, React__default.createElement(_Icon, {
        ...
        target: "_blank",
        rel: "noopener noreferrer"
      }, t('header:help.articles')))), React__default.createElement(SubMenu$1, {
        title: React__default.createElement("span", null, React__default.createElement(_Icon, {
          type: "global"
        }), isCN() ? '简体中文' : 'English')
      }, React__default.createElement(_Menu.Item, {
        key: "zh"
      }, "\u7B80\u4F53\u4E2D\u6587"), React__default.createElement(_Menu.Item, {
        key: "en"
      }, "English"))));
    };
...
i18next.use(Backend).use(LngDetector).use(reactI18next.initReactI18next).init({
  fallbackLng: {
    'zh-Hant': ['zh'],
    'zh-TW': ['zh'],
    'zh-CN': ['zh'],
...
var CommonHader = function CommonHader(_ref) {
  ...
  if (t === undefined) {
    // 未指定国际化内容,引入自带的国际化配置
    var _useTranslation = reactI18next.useTranslation('header', {
      useSuspense: false,
      i18n: i18next
    }),
  ...
  }, React__default.createElement(WebHeader, {
    theme: theme,
    userInfo: userInfo,
  ...
  }, React__default.createElement(WapHeader, {
